...
import {_createFile, createFile, File} from './file.js';
...
test('userito: file: createFile: uses custom path', (t) => {
    const read = stub().returns([]);
    const write = stub();
    const file = createFile('/custom/path.json', schema, {read, write});
...
test('userito: file: createFile: uses untildified path', (t) => {
    const read = stub().returns([]);
    const write = stub();
    const file = createFile('~/mydir/users.json', schema, {read, write});
...
test('userito: file: createFile: uses default path when no path given', (t) => {
    const read = stub().returns([]);
    const write = stub();
    const file = createFile(null, schema, {read, write});
...
test('userito: file: createFile: returns File instance', (t) => {
    const read = stub().returns([]);
    const write = stub();
    const file = createFile('/custom.json', schema, {read, write});
